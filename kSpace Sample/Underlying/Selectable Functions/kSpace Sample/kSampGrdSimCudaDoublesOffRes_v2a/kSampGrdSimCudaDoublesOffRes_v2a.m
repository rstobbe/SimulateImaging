...
classdef kSampGrdSimCudaDoublesOffRes_v2a < handle

properties (SetAccess = private)                   
    Method = 'kSampGrdSimCudaDoublesOffRes_v2a'
    IF
    KRN
    B0Map
    Delay = 0
...
% Constructor
%==================================================================  
function [KSMP,err] = kSampGrdSimCudaDoublesOffRes_v2a(KSMPipt)    
    err.flag = 0;
...
%     T = T2;
    ...
    StatLev = 3;
    [SampDat,err] = mSampOffResCUDADoubles_v1j(zfOb,Off,T,Kx,Ky,Kz,KERN,CONV,StatLev);    
    if err.flag
        return
    end
