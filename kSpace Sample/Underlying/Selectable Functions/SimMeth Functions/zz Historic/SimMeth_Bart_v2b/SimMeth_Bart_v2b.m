...
classdef SimMeth_Bart_v2b < handle

properties (SetAccess = private)                   
    Method = 'SimMeth_Bart_v2b'
    SimObjectfunc
    OB
    Samplefunc
    KSMP
...
% Constructor
%==================================================================  
function [SIMMETH,err] =  SimMeth_Bart_v2b(SIMMETHipt)    
    err.flag = 0;
...
function err = Simulate(SIMMETH,WRT)
    ...
    for n = 1:length(WRT.STCH)
        ...
        SIMMETH.SampDat{n} = zeros(1,sz(1),sz(2),sz(3),'single');
        SIMMETH.SampDat{n}(1,:,:,:) = SampDat0;
