...
classdef SimObject_SheppLoganFlip_v2a < handle

properties (SetAccess = private)                   
    Method = 'SimObject_SheppLoganFlip_v2a'
    LongDim
    ObMatSz
    SimOb
    PixWidth
...
% Constructor
%==================================================================  
function [SIMOB,err] = SimObject_SheppLoganFlip_v2a(SIMOBipt)    
    err.flag = 0;
...
function err = BuildSimObject(SIMOB,SIMMETH,WRT)
    ...
    Phantom = flip(Phantom,1);
    Phantom = flip(Phantom,2);
    Phantom = flip(Phantom,3);
    bot = (M - MatDim)/2 + 1;
    top = bot + MatDim - 1;
