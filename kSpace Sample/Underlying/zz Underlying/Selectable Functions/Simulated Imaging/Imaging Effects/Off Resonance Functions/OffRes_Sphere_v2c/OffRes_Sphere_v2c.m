%==================================================================
% (v2c)
%   - Calling change for 'Sample_Standard_v3a'
%==================================================================

classdef OffRes_Sphere_v2c < handle

properties (SetAccess = private)                   
    Method = 'OffRes_Sphere_v2c'
    OffRes
    SphereDiam
    Delay
    FiltVox
...
% Constructor
%==================================================================  
function [B0MAP,err] = OffRes_Sphere_v2c(B0MAPipt)    
    err.flag = 0;
    B0MAP.SphereDiam = str2double(B0MAPipt.('SphereDiam'));
    B0MAP.OffRes = str2double(B0MAPipt.('OffRes'));
    B0MAP.Delay = str2double(B0MAPipt.('Delay'))/1000;
...
function [err] = AddPreEffect(B0MAP,SIMMETH)
    ...
    SIMMETH.KSMP.SetOffResMap(single(B0Map));
