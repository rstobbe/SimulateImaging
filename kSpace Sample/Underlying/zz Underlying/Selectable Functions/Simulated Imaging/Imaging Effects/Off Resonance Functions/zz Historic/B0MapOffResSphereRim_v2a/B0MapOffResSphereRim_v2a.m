...
classdef B0MapOffResSphereRim_v2a < handle

properties (SetAccess = private)                   
    Method = 'B0MapOffResSphereRim_v2a'
    OffRes
    RimThick
    SphereDiam
    Panel = cell(0)
...
% Constructor
%==================================================================  
function [B0MAP,err] = B0MapOffResSphereRim_v2a(B0MAPipt)    
    err.flag = 0;
...
function [SampDat,err] = AddPostEffect(B0MAP,SIMMETH,STCH,SampDat)
    ...
    B0MAP.Panel(3,:) = {'OffRes',B0MAP.OffRes,'Output'};
